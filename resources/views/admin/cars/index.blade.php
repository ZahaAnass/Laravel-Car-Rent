                        ...
                        <table class="table">
                            ...
                            @forelse($cars as $car)
                                <tr>
                                    ...
                                    <td class="">
                                        <a href="{{ route('admin.cars.edit', $car) }}" class="btn btn-edit inline-flex items-center">
                                        ...
                                        <a href="{{ route("admin.cars.image", $car) }}" class="btn btn-edit inline-flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor"
                                                    style="width: 12px; margin-right: 5px">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center p-large">You have no cars listed yet.
                                        <a href="{{ route('admin.cars.create') }}">Add a new car</a>
                                    </td>
                                </tr>
                            @endforelse
