<header class="navbar admin-navbar">
    <div class="container navbar-content">
        ...
        <form action="{{ route('logout') }}" method="POST" class="ml-auto">
            @csrf
            <button class="btn btn-logout flex items-center">
                <svg style="width: 18px; fill: currentColor; margin-right: 4px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
